            ...
            <Dialog as="div" className="relative z-10" onClose={closeModal}>
                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex min-h-full items-center justify-center p-4 text-center">
                        ...
                        >
                            <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-[color:var(--secondary-select)] border p-6 text-left align-middle  transition-all">

                                <div className="mt-2 flex flex-col gap-4">
                                    {
                                        configs.navItem.map((e, idx) => <a key={idx} href={e.href} onClick={closeModal}><Button className="w-full" >{e.text}</Button></a>)
                                    }
                                    {
